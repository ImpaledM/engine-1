<?php
		...
		$mcFileManagerConfig['filesystem.path'] = '../../../../file/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../file/'; // absolute or relative from this script path.
